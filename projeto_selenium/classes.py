...
from projeto_selenium.modulos.funcoes import *
...
class Automatizar:
    ...
    def pega_cotacao(self, empresas):
        ...
        self.__site['Data'] = pd.to_datetime(self.__site['Data'])
        self.__site.set_index('Data', inplace=True)
